	...
	return (
		...
		>
			<div
				...
				className="flex flex-col gap-6 tracking-wider py-6 px-12 rounded-md bg-[#10141E]"
			>
				<span className="font-medium text-lg">{message}</span>
				<div className="flex justify-end gap-4">
					<button
						onClick={onCancel}
						className="py-[5px] px-4 text-sm rounded-md font-semibold cursor-pointer border border-sky-300 text-sky-300"
					>
						Cancel
					</button>
